...
class FindIncludedInParentsAgent(ScAgentClassic):
    def __init__(self):
        super().__init__(SearchModuleIdentifiers.ACTION_FIND_INCLUDED_IN_PARENTS)
    ...
    def run(self, action_node: ScAddr) -> ScResult:
        ...
        result_set = ScSet(*(result.get('inclusions') for result in search_results))
