...
class FindStagesListSerumPumpingAgent(ScAgentClassic):
    def __init__(self):
        super().__init__(SearchModuleIdentifiers.ACTION_FIND_STAGES_LIST_SERUM_PUMPING)  # Регистрируем действие
